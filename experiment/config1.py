...
classifier_config = {
    # 训练数据集
    'train_file1': 'data/news_data/train_data1.csv',
    'train_file2': 'data/news_data/train_data2.csv',
    # 验证数据集
    'dev_file1': 'data/news_data/val_data1.csv',
    'dev_file2': 'data/news_data/val_data2.csv',
    # 向量维度
    'embedding_dim': 240,
    # 存放字/词表的地方
